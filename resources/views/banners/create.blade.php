<x-app-layout>
    <div class="bg-white min-h-[800px]">
        ...
        <!-- Banner form -->
        <form action="{{ route('banners.store') }}" method="POST" class="w-full" enctype="multipart/form-data">
            @csrf
            <div class="mb-10 items-center grid lg:grid-cols-2 gap-6 m-[80px] justify-center">
                ...
                <div class="lg:col-span-1">
                    ...
                    <textarea
                        ...
                        id="description" placeholder="Enter a brief description of your banner" name="description">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
