<x-app-layout>
    <div class="note-container py-12">
        <x-breadcrumb :breadcrumbs="[['name' => 'Team', 'url' => route('staffs.index')]]" />
        <div class="m-4 py-4 overflow-x-auto">
            <div class="inline-block min-w-full shadow rounded-lg overflow-hidden flex-col">
                <div class="sm:flex justify-start sm:justify-between items-center mb-4">
                    <h1 class="sm:text-4xl text-3xl font-semibold sm:pb-4 pb-8 dark:text-white mt-6">Team</h1>
                ...
                <script>
                    ...
                    const toggleCheckbox = document.querySelector(
                        'input[wire:model="staff.status"]'); // Assuming your toggle input has this selector
