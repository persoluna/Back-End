<x-app-layout>
    <div class="note-container py-12">
        <x-breadcrumb :breadcrumbs="[['name' => 'Products', 'url' => route('products.index')]]" />
        <div class="m-4 py-4 overflow-x-auto">
            <div class="inline-block min-w-full shadow rounded-lg overflow-hidden flex-col">
                <div class="grid gap-6 justify-start sm:justify-between lg:grid-cols-1 items-center mb-4">
                    <h1 class="sm:text-4xl text-3xl font-semibold sm:pb-4 pb-8">Products</h1>
                ...
                <a href="{{ route('products.export') }}"
                    ...
                    <i class="fas fa-download mr-2"></i> Export Products Data
                </a>
                @if (session('success'))
        ...
        <div class="grid justify-end">
            <form action="{{ route('products.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="file" class="form-label block text-sm font-medium text-gray-700">Import Products
                        Data</label>
                ...
                <button type="submit" id="importButton"
                    ...
                    <i class="mr-2"></i> Import Products Data
                </button>
            </form>
            <script>
