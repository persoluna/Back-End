<x-app-layout>
    <div class="bg-white min-h-[1200px] pt-12">
        ...
        <!-- service form -->
        <form action="{{ route('services.update', $service) }}" method="POST" class="w-full" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-10 items-center grid lg:grid-cols-2 gap-6 m-[80px] justify-center">
                ...
                <div class="lg:col-span-2">
                    ...
                    <textarea
                        ...
                        id="description" placeholder="Enter a brief description" name="description">{{ $service->description }}</textarea>
                    @error('description')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
