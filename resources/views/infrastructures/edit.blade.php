<x-app-layout>
    <div class="bg-white pt-12 pb-12">
        ...
        <!-- form -->
        <form action="{{ route('infrastructures.update', $infrastructure->id) }}" method="POST" class="w-full" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-10 items-center grid lg:grid-cols-2 gap-6 m-[80px] justify-center">
                ...
                <div class="lg:col-span-1">
                    ...
                    <textarea
                        ...
                        name="description">{{ old('description', $infrastructure->description) }}</textarea>
                    @error('description')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
