    ...
    <div class="bg-white pt-12 pb-12">
        @if (isset($infrastructure))
            <x-breadcrumb :breadcrumbs="[
                ...
                ['name' => $infrastructure->title, 'url' => route('infrastructures.edit', $infrastructure->id)],
            ]" />
        @else
            <x-breadcrumb :breadcrumbs="[
        ...
        <div class="mb-8 space-y-3">
            <h1 class="text-3xl font-semibold text-center sm:text-left sm:pl-[80px] pt-[90px]">Edit Infrastructure</h1>
        </div>
