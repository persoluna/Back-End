<x-app-layout>
    <div class="bg-white min-h-[800px] pt-12">
        <x-breadcrumb :breadcrumbs="[['name' => 'SMTP Settings', 'url' => route('smtp-settings.index')]]" />

        <!-- SMTP Settings title -->
        <div class="mb-8 space-y-3">
            <h1 class="text-3xl font-semibold text-center sm:text-left sm:pl-[80px] pt-[90px]">SMTP Settings</h1>
        </div>
