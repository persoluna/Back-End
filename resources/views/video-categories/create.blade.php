    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <header class="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg shadow-lg p-6 mb-8">
            ...
            <nav class="flex items-center space-x-4">
                ...
                <a href="{{ route('videocategories.index') }}" class="text-white hover:text-gray-200">Video Categories</a>
                <span class="text-white">/</span>
                <a href="{{ route('videocategories.create') }}" class="text-white hover:text-gray-200">Create Category</a>
            </nav>
        </header>
        ...
        <!-- Category form -->
        <form action="{{ route('videocategories.store') }}" method="POST" class="w-full" enctype="multipart/form-data">
            @csrf
