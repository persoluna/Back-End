<x-app-layout>
    <div class="bg-white pt-12 pb-12">
        <x-breadcrumb :breadcrumbs="[
            ...
            ['name' => 'Create Quality Control', 'url' => route('qualitycontrols.create')],
        ]" />

        <!-- creation title and description -->
        <div class="mb-8 space-y-3">
            <h1 class="text-3xl sm:text-4xl font-semibold text-center pt-[90px]">Add Quality controls</h1>
            <p class="text-gray-500 text-center text-xl">Enter the Qualitycontrol details.</p>
        </div>

        <!-- form -->
        <form action="{{ route('qualitycontrols.store') }}" method="POST" class="w-full" enctype="multipart/form-data">
            @csrf
