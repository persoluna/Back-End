                ...
                <tr class="font-medium">
                    ...
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        <label class="inline-flex items-center cursor-pointer">
                            ...
                            <span
                                class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">{{ $blogcategory->status ? 'Active' : 'Inactive' }}</span>
                        </label>
                    </td>
                </tr>
            @empty
                <tr>
                    <td colspan="5" class="text-center pt-10 text-gray-500 dark:text-gray-400 font-bold">
                        ...
                        <img src="{{ asset('storage/DrawKit-onlineshopping-Illustration-10.svg') }}" alt="No blog category found" class="mx-auto mb-4 h-80 w-80">
                    </td>
                </tr>
            @endforelse
        </tbody>
