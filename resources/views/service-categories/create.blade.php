<x-app-layout>
    <div class="bg-white pt-12">
        <x-breadcrumb :breadcrumbs="[
            ...
            ['name' => 'Create ServiceCategory', 'url' => route('servicecategories.create')],
        ]" />

        <!-- Service Category creation title and description -->
        <div class="mb-8 space-y-3">
            <h1 class="text-3xl sm:text-4xl font-semibold text-center pt-[90px]">Add Your Service Category</h1>
