    ...
    <div class="note-container py-12">
        ...
        <div class="m-4 py-4 overflow-x-auto">
            <div class="inline-block min-w-full shadow rounded-lg overflow-hidden flex-col">
                ...
                <a href="{{ route('whychooseus.export') }}"
                    ...
                    <i class="fas fa-download mr-2"></i> Export Whychooseus Data
                </a>
                @if (session('success'))
                ...
                <script>
                    ...
                    const toggleCheckbox = document.querySelector(
                        'input[wire:model="whychooseus.status"]');
                ...
                {{-- ! Live wire search for Why choose us --}}
                <div class="py-12">
        ...
        <div class="grid justify-end pr-12">
            <form action="{{ route('whychooseus.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="file" class="form-label block text-sm font-medium text-gray-700">Import Whychooseus
                        Data</label>
