<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <header class="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg shadow-lg p-6 mb-8">
            <h1 class="text-4xl font-bold text-white mb-4">Edit Why Choose Us</h1>
            <nav class="flex items-center space-x-4">
                ...
                @if (isset($whychooseus))
                    <span class="text-white">/</span>
                    <a href="{{ route('whychooseus.edit', $whychooseus->id) }}" class="text-white hover:text-gray-200">{{ $whychooseus->why_title }}</a>
                @endif
            </nav>
        </header>
        ...
        <!-- Why us form -->
        <form id="editwhychooseusForm" action="{{ route('whychooseus.update', $whychooseus->id) }}" method="POST" class="w-full"
            ...
            <div class="mb-10 items-center grid lg:grid-cols-2 gap-6 m-[80px] justify-center">
                ...
                <div class="lg:col-span-2">
                    ...
                    <textarea
                        ...
                        id="editor" placeholder="Enter the Why choose us Description" name="why_description">{{ old('why_description', $whychooseus->why_description) }}</textarea>
    ...
    <script>
        ...
        document.getElementById('editwhychooseusForm').addEventListener('submit', function(event) {
        ...
        document.getElementById('leave-page').addEventListener('click', function() {
            ...
            window.location.href = '{{ route('whychooseus.index') }}'; // Redirect to index
        });
