...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 pt-4 overflow-y-auto bg-white dark:bg-gray-900">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <button type="button"
                    class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ Route::currentRouteNamed('banners.index') || Route::currentRouteNamed('counters.create') || Route::currentRouteNamed('banners.create') || Route::currentRouteNamed('counters.index') || Route::currentRouteNamed('applications.index') || Route::currentRouteNamed('applications.create') || Route::currentRouteNamed('whychooseus.index') || Route::currentRouteNamed('whychooseus.create') || Route::currentRouteNamed('clients.index') || Route::currentRouteNamed('clients.create') || Route::currentRouteNamed('testimonials.index') || Route::currentRouteNamed('testimonials.create') || Route::currentRouteNamed('headings.edit', 6) || Route::currentRouteNamed('achievements.index') || Route::currentRouteNamed('achievements.create') || Route::currentRouteNamed('galleries.index') || Route::currentRouteNamed('galleries.create') || Route::currentRouteNamed('servicecategories.index') || Route::currentRouteNamed('servicecategories.create') || Route::currentRouteNamed('services.index') || Route::currentRouteNamed('services.create') ? 'parent-active' : '' }}"
                ...
                <ul id="dropdown-example"
                    class="space-y-2 {{ Route::currentRouteNamed('banners.index') || Route::currentRouteNamed('counters.index') || Route::currentRouteNamed('counters.create') || Route::currentRouteNamed('banners.create') || Route::currentRouteNamed('applications.index') || Route::currentRouteNamed('applications.create') || Route::currentRouteNamed('whychooseus.index') || Route::currentRouteNamed('whychooseus.create') || Route::currentRouteNamed('clients.index') || Route::currentRouteNamed('clients.create') || Route::currentRouteNamed('testimonials.index') || Route::currentRouteNamed('testimonials.create') || Route::currentRouteNamed('achievements.index') || Route::currentRouteNamed('achievements.create') || Route::currentRouteNamed('headings.edit', 6) || Route::currentRouteNamed('galleries.index') || Route::currentRouteNamed('galleries.create') || Route::currentRouteNamed('servicecategories.index') || Route::currentRouteNamed('servicecategories.create') || Route::currentRouteNamed('services.index') || Route::currentRouteNamed('services.create') ? 'block' : 'hidden' }}">
                    <li>
