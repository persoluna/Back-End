<x-app-layout>
    <div class="bg-white min-h-[800px] pt-12">
        <x-breadcrumb :breadcrumbs="[
            ...
            ['name' => 'Create Achievement', 'url' => route('achievements.create')],
        ]" />

        <!-- Achievement creation title and description -->
        <div class="mb-8 space-y-3">
            <h1 class="text-3xl sm:text-4xl font-semibold text-center pt-[90px]">Add Your Achievement</h1>
            <p class="text-gray-500 text-center text-xl">Enter the Achievement details.</p>
        </div>

        <!-- achievements form -->
        <form action="{{ route('achievements.store') }}" method="POST" class="w-full" enctype="multipart/form-data">
            @csrf
            <div class="mb-10 items-center grid lg:grid-cols-2 gap-6 m-[80px] justify-center">
                ...
                <div class="lg:col-span-1">
                    ...
                    <input
                        ...
                        id="title" placeholder="Enter the Application title" type="text"
                ...
                <div class="lg:col-span-1">
                    ...
                    <img id="image-preview" src="" alt="Achievement Image Preview"
