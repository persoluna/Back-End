<x-app-layout>
    <div class="bg-white min-h-[1500px] pt-12">
        <x-breadcrumb :breadcrumbs="[
            ['name' => 'Categories', 'url' => route('categories.index')],
            ['name' => 'Create Category', 'url' => route('categories.create')],
        ]" />

        <!-- Category creation title and description -->
        <div class="mb-8 space-y-3">
            <h1 class="text-3xl sm:text-4xl font-semibold text-center pt-[90px]">Add Your Category</h1>
            <p class="text-gray-500 text-center text-xl">Enter the Category details.</p>
        </div>

        <!-- Category form -->
        <form action="{{ route('categories.store') }}" method="POST" class="w-full" enctype="multipart/form-data">
            @csrf
            <div class="mb-10 items-center grid lg:grid-cols-2 gap-6 m-[80px] justify-center">
                ...
                <div class="lg:col-span-1">
                    ...
                    <img id="category-icon-preview" src="" alt="Category Icon Preview"
                        class="min-h-[100px] w-auto pt-2 text-base">
                    @error('icon')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                ...
                <div class="lg:col-span-1">
                    ...
                    <input
                        class="border-input bg-background ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring flex h-10 w-full rounded-md border px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                        id="icon_alt_tag" placeholder="Enter the Icon alt tag for the Category Icon" type="text"
