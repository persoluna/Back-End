<x-app-layout>
    <div class="bg-white min-h-[800px] pt-12">
        @if (isset($footer))
            <x-breadcrumb :breadcrumbs="[['name' => 'Update Footer', 'url' => route('footers.edit', $footer->id)]]" />
        @else
        ...
        <div class="mb-8 space-y-3">
            <h1 class="text-3xl font-semibold text-center sm:text-left sm:pl-[80px] pt-[90px]">Edit Footer</h1>
        </div>

        <!-- Footer edit form -->
        <form action="{{ route('footers.update', $footer->id) }}" method="POST" class="w-full"
            ...
            <div class="mb-10 items-center grid lg:grid-cols-2 gap-6 m-[80px] justify-center">
                ...
                <div class="lg:col-span-1">
                    <label
                        ...
                        for="news_letter">News letter</label>
                    <textarea
                        ...
                        id="news_letter" placeholder="Enter the news letter" type="text" name="news_letter">{{ old('news_letter', $footer->news_letter) }}</textarea>
                    @error('news_letter')
                ...
                <div class="lg:col-span-1">
                    ...
                    <input
                        ...
                        id="instagram_link" placeholder="Enter the instagram link" type="link" name="instagram_link"
                ...
                <div class="lg:col-span-1">
                    <label
                        class="text-base font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                        for="facebook_link">Facebook link</label>
                    <input
                        class="border-input bg-background ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring flex h-10 w-full rounded-md border px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                        id="facebook_link" placeholder="Enter the facebook link" type="link" name="facebook_link"
                ...
                {{-- Google Link input field --}}

                <div class="lg:col-span-1">
                    <label
                        class="text-base font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                        for="google_link">Google link</label>
                    <input
                        class="border-input bg-background ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring flex h-10 w-full rounded-md border px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                        id="google_link" placeholder="Enter the google link" type="link" name="google_link"
                        value="{{ old('google_link', $footer->google_link) }}">
                    @error('google_link')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
                ...
                <div class="lg:col-span-2">
                    ...
                    <input
                        class="border-input bg-background ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring flex h-10 w-full rounded-md border px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                        id="location" placeholder="Enter Location" type="text" name="location"
                ...
                <div class="lg:col-span-1">
                    <label
                        class="text-base font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                        for="phone2">Phone2</label>
                    <input
                        class="border-input bg-background ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring flex h-10 w-full rounded-md border px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                        id="phone2" placeholder="Enter phone2" type="text" name="phone2"
                        value="{{ old('phone2', $footer->phone2) }}">
                    @error('phone2')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
                ...
                <!-- footer email2 input field -->

                <div class="lg:col-span-1">
                    <label
                        class="text-base font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                        for="email2">email2</label>
                    <input
                        class="border-input bg-background ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring flex h-10 w-full rounded-md border px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                        id="email2" placeholder="Enter the email2" type="email" name="email2"
                ...
                <div class="lg:col-span-1">
                    ...
                    <textarea
                        class="border-input bg-background ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring flex h-20 w-full rounded-md border px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                        id="address" placeholder="Enter the address" type="text" name="address">{{ old('address', $footer->address) }}</textarea>
                    @error('address')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
                ...
                <div class="lg:col-span-1">
                    ...
                    <div id="logo-image-container">
                        @if ($footer->logo)
                            <img src="{{ asset('storage/footer_logos/' . $footer->logo) }}"
                                alt="{{ $footer->alt_tag }}" class="min-h-[100px] w-auto p-2">
                        @endif
                    </div>

                    <img id="logo-image-preview" src="" alt="Preview Image"
                ...
                <div class="lg:col-span-1">
                    <label
                        class="text-base font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                        for="alt_tag">Logo Alt Tag</label>
                    <input
                        class="border-input bg-background ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring flex h-10 w-full rounded-md border px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                        id="alt_tag" placeholder="Enter the alt tag for the logo" type="text" name="alt_tag"
                        value="{{ old('alt_tag', $footer->alt_tag) }}">
                    @error('alt_tag')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
                ...
                <div class="lg:col-span-1">
                    ...
                    <input
                        ...
                        name="meta_description" value="{{ old('meta_description', $footer->meta_description) }}">
                ...
                <div class="lg:col-span-1">
                    ...
                    <input
                        ...
                        value="{{ old('meta_keyword', $footer->meta_keyword) }}">
                    @error('meta_keyword')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
                ...
                <div class="lg:col-span-1">
                    ...
                    <input
                        ...
                        value="{{ old('meta_canonical', $footer->meta_canonical) }}">
