<x-app-layout>
    <div class="note-container py-12">
        <x-breadcrumb :breadcrumbs="[['name' => 'Clients', 'url' => route('clients.index')]]" />
        <div class="m-4 py-4 overflow-x-auto">
            <div class="inline-block min-w-full shadow rounded-lg overflow-hidden flex-col">
                <div class="sm:flex justify-start sm:justify-between items-center mb-4">
                    <h1 class="sm:text-4xl text-3xl font-semibold  sm:pb-4 pb-8">Client</h1>
                ...
                <a href="{{ route('clients.export') }}"
                    ...
                    <i class="fas fa-download mr-2"></i> Export Clients Data
                </a>
                @if (session('success'))
                ...
                <script>
                    ...
                    const toggleCheckbox = document.querySelector(
                        'input[wire:model="client.status"]');
                    ...
                    toggleCheckbox.addEventListener('change', function() {
                        if (this.checked) {
                            ...
                            toggleMessage.textContent = 'Clinet status changed to Inactive.';
                            toggleMessage.classList.remove('hidden'); // Show the message
                        }
        ...
        <div class="grid justify-end">
            <form action="{{ route('clients.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="file" class="form-label block text-sm font-medium text-gray-700">Import Clients
                        Data</label>
                ...
                <button type="submit" id="importButton"
                    ...
                    <i class="mr-2"></i> Import Clients Data
                </button>
            </form>
            <script>
