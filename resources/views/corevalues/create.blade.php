<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <header class="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg shadow-lg p-6 mb-8">
            <h1 class="text-4xl font-bold text-white mb-4">Enter Your Core Value</h1>
            <nav class="flex items-center space-x-4">
                ...
                <span class="text-white">/</span>
                <a href="{{ route('corevalues.create') }}" class="text-white hover:text-gray-200">Core Value Create</a>
            </nav>
        </header>
