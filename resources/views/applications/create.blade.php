<x-app-layout>
    <div class="bg-white min-h-[800px] pt-12">
        <x-breadcrumb :breadcrumbs="[
            ...
            ['name' => 'Create Applications', 'url' => route('applications.create')],
        ]" />

        <!-- Application creation title and description -->
        <div class="mb-8 space-y-3">
            <h1 class="text-3xl sm:text-4xl font-semibold text-center pt-[90px]">Add Your Application</h1>
            <p class="text-gray-500 text-center text-xl">Enter the Application details.</p>
        </div>
