<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <header class="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg shadow-lg p-6 mb-8">
            <h1 class="text-4xl font-bold text-white mb-4">Edit Application</h1>
            <nav class="flex items-center space-x-4">
                ...
                @if (isset($application))
                    <span class="text-white">/</span>
                    <a href="{{ route('applications.edit', $application->id) }}" class="text-white hover:text-gray-200">{{ $application->application_title }}</a>
                @endif
            </nav>
        </header>
        ...
        <!-- Application form -->
        <form id="editApplicationForm" action="{{ route('applications.update', $application->id) }}" method="POST" class="w-full"
            ...
            <div class="mb-10 items-center grid lg:grid-cols-2 gap-6 m-[80px] justify-center">
                ...
                <div class="lg:col-span-1">
                    ...
                    <input
                        ...
                        value="{{ old('application_title', $application->application_title) }}">
                ...
                <div class="lg:col-span-2">
                    ...
                    <textarea id="application_description" name="application_description">
                        {{ old('application_description', $application->application_description) }}
                    </textarea>
                ...
                <div class="lg:col-span-1">
                    ...
                    <input
                        ...
                        name="alt_tag" value="{{ old('alt_tag', $application->alt_tag) }}">
                    @error('alt_tag')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
                ...
                <div class="lg:col-span-1">
                    ...
                    <input
                        ...
                        id="application_image" type="file" name="application_image" onchange="previewImage(event)">

                    <div id="image-container">
                        @if ($application->application_image)
                            <img src="{{ asset('storage/applications/' . $application->application_image) }}"
                                alt="{{ $application->alt_tag }}" class="min-h-[100px] w-auto p-2">
                        @endif
                    </div>
    ...
    <script>
        ...
        document.getElementById('leave-page').addEventListener('click', function() {
            ...
            window.location.href = '{{ route('applications.index') }}'; // Redirect to index
        });
