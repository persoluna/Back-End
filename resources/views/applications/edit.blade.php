    ...
    <div class="bg-white min-h-[800px] pt-12">
        @if (isset($application))
            <x-breadcrumb :breadcrumbs="[
                ...
                ['name' => $application->application_title, 'url' => route('applications.edit', $application->id)],
            ]" />
        @else
            <x-breadcrumb :breadcrumbs="[
        ...
        <div class="mb-8 space-y-3">
            <h1 class="text-3xl font-semibold text-center sm:text-left sm:pl-[80px] pt-[90px]">Edit Application</h1>
        </div>
