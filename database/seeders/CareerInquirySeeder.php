...
class CareerInquirySeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        foreach ($years as $year) {
            ...
            $numInquiries = rand(1, 5); // Adjust the range as needed
            ...
            for ($i = 0; $i < $numInquiries; $i++) {
                ...
                // Generate a fake resume file name
                $resumeFileName = $faker->uuid() . '.pdf';

                DB::table('career_inquiries')->insert([
                    'name' => $faker->name(),
